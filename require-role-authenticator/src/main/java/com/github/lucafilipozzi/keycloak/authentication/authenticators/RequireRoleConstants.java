  ...
  static {
    CONFIG_PROPERTIES =
        ProviderConfigurationBuilder.create()
            ...
            .helpText(
                "Specify whether to apply the role requirement to the user (default; off) or to the impersonator (on).")
            .defaultValue(false)
            .add()
            .property()
            ...
            .helpText(
                "Specify the name of the role that a user is required to have for successful authentication. "
